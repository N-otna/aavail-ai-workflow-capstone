...
def update_train_log(tag, date_eval, eval_test, runtime, MODEL_VERSION, MODEL_VERSION_NOTE, test=False):
    """
    ...
    header = ['unique_id', 'timestamp', 'tag', 'date', 'eval_test', 'model_version',
    ...
    with open(logfile, 'a') as csvfile:
        ...
        to_write = map(str, [uuid.uuid4(), time.time(), tag, date_eval, eval_test,
